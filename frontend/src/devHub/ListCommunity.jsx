...
const CommunityList = () => {
  ...
  const navigate = useNavigate()
   const { setSelectedCommunityGroup } = CommunityGroupSidebarFunction();
  ...
  return (
    <div className="p-6">
                ...
                <div className="mt-4">
                  {community.alreadyIn ? (
                    <div className="flex justify-between">
                      ...
                      <div className='cursor-pointer hover:scale-x-110' onClick={()=>{
                        navigate('/devhub/community')
                        setSelectedCommunityGroup(community)
                      }}>
      ...
      <div className='fixed bottom-10 right-10 bg-gray-800 rounded-full p-3 shadow-lg hover:scale-105 mt-2'>
        <Link
