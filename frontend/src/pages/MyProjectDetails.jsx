...
const MyProjectDetails = () => {
  ...
  const fetchMyProjectsUpdates = async () => {
    ...
    console.log('hhhhhh', data.Updated_List);
    console.log('wwwwwww', projects);
  };
  useEffect(() => {
  ...
  const handleAccept = async developerId => {
   try {
    await axiosInstance.get(`/userdash/InterestRequestAccept/${developerId}`);
  ...
  const handleReject = async developerId => {
    try {
      await axiosInstance.get(`/userdash/InterestRequestReject/${developerId}`);
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center text-gray-500   hover:text-blue-600">
                  ...
                  <span onClick={() => handleProjectClick(project)}>
                    {project.interestedDev.length} interested
                  </span>
                </div>
                        ...
                        >
                          ...
                          {!dev.isRejected && (
                            <div className="flex space-x-2">
                              <button
                                onClick={() => handleAccept(dev.userId._id)}
                              ...
                              <button
                                onClick={() => handleReject(dev.userId._id)}
